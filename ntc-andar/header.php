			...
			ntc_menu(
				...
				array(
					...
					ntc_raw( 'nav.offer' )   => array(
						'url' => $ntc_oferta,
						'sub' => array(
							ntc_raw( 'footer.offer_api' )         => $ntc_oferta . 'substancje-czynne-api/',
							ntc_raw( 'footer.offer_probiotics' )  => $ntc_oferta . 'probiotyki/',
							ntc_raw( 'footer.offer_lactoferrin' ) => $ntc_oferta . 'laktoferyna/',
							ntc_raw( 'footer.offer_colostrum' )   => $ntc_oferta . 'colostrum/',
							ntc_raw( 'footer.offer_proteins' )    => $ntc_oferta . 'bialka-mleka/',
							ntc_raw( 'footer.offer_collagen' )    => $ntc_oferta . 'kolagen/',
							ntc_raw( 'footer.offer_machines' )    => $ntc_oferta . 'maszyny-i-uslugi/#cat-maszyny',
							ntc_raw( 'footer.offer_services' )    => $ntc_oferta . 'maszyny-i-uslugi/#cat-uslugi',
						),
					),

 ...
 * Stopka.
 *
 * Pełna (cztery kolumny) domyślnie, wąska na stronach z blokiem hero kontaktu -
 * tam stopka siedzi tuż pod paskiem CTA i pełna wersja duplikowałaby dane
 * teleadresowe pokazane wyżej.
 *
	...
	<footer class="footer footer--slim">
		<div class="footer-inner">
			...
			<div class="footer-legal">
				<a href="<?php echo esc_url( ntc_url( home_url( '/' ) ) ); ?>"><?php ntc_e( 'footer.home' ); ?></a>
				<a href="<?php echo esc_url( ntc_page_url( 'oferta' ) ); ?>"><?php ntc_e( 'nav.offer' ); ?></a>
			</div>
		</div>
	</footer>
